...
public class MechWorldGenerator implements IWorldGenerator {
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
        ...
        private void GenerateOverworld(Random random, int x, int z, World world) {
            this.addOreSpawn(MechBlocks.oreUranium, world, random, x, z, 10, 25, 5, 0, 32);
            this.addOreSpawn(MechBlocks.oreAluminium, world, random, x, z, 10, 12, 8, 0, 48);
            this.addOreSpawn(MechBlocks.oreCopper, world, random, x, z, 15, 30, 7, 0, 96);
            this.addOreSpawn(MechBlocks.oreTitanium, world, random, x, z, 10, 20, 1, 0, 24);
    }
